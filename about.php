    ...
    <section class="about-section">
        <div class="container about-grid">
            <div class="about-content">
                <h2>Our Story</h2>
                <p>Founded in 2013, Swat Info System began with a simple mission: to help businesses harness the power of technology to grow and succeed in an increasingly digital world.</p>
            ...
            <div class="team-grid">
                <div class="team-member">
                    <div class="member-image">
                        <img src="https://dummyimage.com/mediumrectangle" alt="Team Member" width="100%">
                    </div>
